...
document.addEventListener("DOMContentLoaded", function() {
    // Seleziona l'elemento `gradio-app`
    ...
    if (gradioApp) {
        ...
        // Applica stili CSS al contenitore
        Object.assign(particlesContainer.style, {
            ...
            width: '100%',
            height: '100%',
            zIndex: '-1', // Assicura che le particelle siano dietro altri contenuti
            pointerEvents: 'none', // Permette di cliccare attraverso le particelle
            backgroundColor: 'transparent' // Assicura che il background sia trasparente
        });

        // Inserisce il contenitore come primo figlio di `gradio-app`
        gradioApp.insertAdjacentElement('afterbegin', particlesContainer);

        // Funzione per caricare uno script esterno
        ...
        // Carica particles.js e inizializza le particelle
        loadScript('https://cdn.jsdelivr.net/npm/particles.js@2.0.0/particles.min.js', function() {
            if (typeof particlesJS === 'undefined') {
                console.error('particles.js non è stato caricato correttamente.');
                return;
            }
            ...
            particlesJS("particles-js", {
                "particles": {
                    "number": {
                        "value": 120, // Aumenta il numero delle particelle
                        "density": {
                            "enable": true,
                            "value_area": 700
                        }
                    ...
                    "color": {
                        "value": ["#ff5722", "#e64a19", "#ff9800"] // Usa più colori per maggiore evidenza
                    },
                    "shape": {
                        "type": "circle", // Puoi cambiare in "edge", "triangle", "polygon", "star", "image"
                        "stroke": {
                            "width": 0,
                            "color": "#000000"
                        },
                    ...
                    "opacity": {
                        "value": 0.8, // Aumenta l'opacità per maggiore visibilità
                        "random": false,
                        "anim": {
                            "enable": true,
                            "speed": 0.5,
                    ...
                    "size": {
                        "value": 5, // Aumenta la dimensione delle particelle
                        "random": true,
                        "anim": {
                            "enable": true,
                            "speed": 2,
                    ...
                    "line_linked": {
                        ...
                        "distance": 150,
                        "color": "#ff5722",
                        "opacity": 0.6, // Aumenta l'opacità delle linee
                        "width": 1
                    },
                    "move": {
                        "enable": true,
                        "speed": 4, // Riduci leggermente la velocità per un effetto più stabile
                        "direction": "none",
                        "random": false,
                        "straight": false,
                        "out_mode": "out",
                ...
                "interactivity": {
                    ...
                    "events": {
                        "onhover": {
                            "enable": true,
                            "mode": "repulse" // Puoi cambiare in "grab", "bubble", "repulse"
                        },
                        "onclick": {
                            "enable": true,
                            "mode": "push" // Puoi cambiare in "remove", "bubble", "repulse"
                        },
                        "resize": true
                    },
                    "modes": {
                        "repulse": {
                            "distance": 120, // Aumenta la distanza di repulsione
                            "duration": 0.6 // Aumenta la durata dell'effetto
                        },
                        "push": {
                            "particles_nb": 5 // Aumenta il numero di particelle aggiunte
                        }
                    }
                },
                "retina_detect": true
        ...
        console.warn("Elemento `gradio-app` non trovato. Verifica il selettore.");
    }
});
